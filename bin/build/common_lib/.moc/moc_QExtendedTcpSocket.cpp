...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SCI__Network__QExtendedTcpSocket_t, stringdata) + ofs \
...
void *SCI::Network::QExtendedTcpSocket::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SCI__Network__QExtendedTcpSocket.stringdata))
